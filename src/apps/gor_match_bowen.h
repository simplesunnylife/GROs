#ifndef EXAMPLES_ANALYTICAL_APPS_GOR_MATCH_BOWEN_H_
#define EXAMPLES_ANALYTICAL_APPS_GOR_MATCH_BOWEN_H_
...
#include "flags.h"
#include "gor_match_bowen/gor_match_bowen.h"
#include "timer.h"
...
void Run() {
  ...
  using AppType = GorMatch<GraphType>;
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GOR_MATCH_H_
